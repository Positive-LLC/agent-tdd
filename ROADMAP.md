...
- ✅ User-facing skills: `/agent-tdd:atdd` (real workflow), `/agent-tdd:atdd-demo` (canned 1-wave demo, no final merge — added v0.5.0), and `/agent-tdd:atdd-compact` (session-handoff utility for compacted Roots — added v0.8.0)
